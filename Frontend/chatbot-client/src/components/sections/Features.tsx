  ...
  const features = [
    {
      ...
      description: 'Your chatbot is specifically trained on your PDFs, website content, documents, or knowledge base.',
      icon: (
    ...
    },
    {
      ...
      description: 'Easy integration with HTML, WordPress, Shopify, Wix, or any other platform you use.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'We handle all the technical aspects so you can focus on your business needs.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Your AI assistant works 24/7, handling customer inquiries even when you're asleep.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Match your brand's colors, style, and tone of voice for a consistent user experience.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'We keep your chatbot updated with new data and improvements to ensure optimal performance.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
